...
public interface ServicioAutenticacionInterface extends Remote {
	 ...
	 * @return int -2 siel cliente no esta registrado, -1 si la repo no esta online,
	 ...
	 * @param nombre
	 *            String el nombre del cliente
	 * @return int -1 si la repo no esta online, 0 si ya existe ese cliente, id
	 *         unico del cliente en otro caso
	 * @throws RemoteException
	 ...
	 * @return int -1 si la repo no esta registrada, 0 si ya esta autenticada, id
	 ...
	 * 
	 * @param sesion
	 *            int el id seion de la repo a desconectar
	 * @throws RemoteException
	 */
