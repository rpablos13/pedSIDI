...
public class Regulador {
	...
	public static void main(String[] args) throws Exception {
		...
		// Levantar Mercancía
		ServicioMercanciasImpl mercancia = new ServicioMercanciasImpl();
		URLRegistro = "rmi://" + direccion + ":" + puerto + "/almacen";
		Naming.rebind(URLRegistro, mercancia);
		System.out.println("Mercancías levantado con éxito");

		// Levantar Auntentificador
		...
		System.out.println("Autentificador levantado con éxito");
	...
	// "Listar Clientes","Listar Repositorios","Listar Parejas
	// Repositorio-Cliente"});
	// switch(opcion){
